...
maven_install(
    name = "m2local_testing_fetch_sources",
    artifacts = [
        # this is a test jar built for integration
        # tests in this repo
        "com.example:kt:1.0.0",
...
maven_install(
    name = "m2local_testing_fetch_sources_repin",
    artifacts = [
        # this is a test jar built for integration
        # tests in this repo
        "com.example:kt:1.0.0",
    ...
    fetch_sources = True,
    maven_install_json = "//tests/custom_maven_install:m2local_testing_fetch_sources_with_pinned_file_install.json",
    repositories = [
        "m2Local",
        "https://repo1.maven.org/maven2",
    ],
