...
public class GMavenToBazel {
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (String repositoryName : artifacts.keySet()) {
      Artifact artifact = artifacts.get(repositoryName);
      String artifactString = artifact.toArtifactString();
      bzlWriter.println();
      bzlWriter.println(String.format("  %s(", artifact.rule()));
  ...
  static class Artifact {
    ...
    String toArtifactString() {
      return getArtifactString(groupId, artifactId, version);
    }
