...
public class ResolutionResult {
  ...
  private final Map<Coordinates, Set<Coordinates>> exclusions;

  public ResolutionResult(Graph<Coordinates> resolution,
  ...
  public Map<Coordinates, Set<Coordinates>> getExclusions() {
    return exclusions;
  }
}
