...
public class MavenSigning {
     ...
     * @throws IOException
     */
    protected static Path in_memory_pgp_sign(Path toSign, String key, String password) throws IOException {
    ...
    private static boolean verify(Path originFilePath, PGPSignature signature, PGPPublicKey publicKey) throws PGPException {
